                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          {inCart > 0 ? (
                            ...
                            <button
                              onClick={() => addToCart(item)}
                              className="px-3 py-1 bg-[#d8ff3c] hover:bg-[#d8ff3c] text-[#0b0b0c] text-sm transition"
                            >
                              Add
                            </button>
                          )}
              ...
              {cart.length > 0 && (
                <div className="mt-4 pt-3 border-t border-[#f2f0ea]/10">
                  ...
                  <button
                    ...
                    disabled={adding}
                    className="w-full px-4 py-2.5 bg-[#d8ff3c] hover:bg-[#d8ff3c] text-[#0b0b0c] font-medium transition disabled:opacity-50 flex items-center justify-center gap-2"
                  >
                    {adding ? (
                      <>
                        <Loader2 className="w-4 h-4 animate-spin" />
          ...
          {!showAddSection ? (
            <>
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-[#d8ff3c] hover:bg-[#d8ff3c] text-[#0b0b0c] font-medium transition flex items-center justify-center gap-2"
              >
                <Plus className="w-4 h-4" />
                Add Items
              </button>
