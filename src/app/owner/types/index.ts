...
export type NavTab = 'dashboard' | 'sessions' | 'customers' | 'stations' | 'tournaments' | 'memberships' | 'coupons' | 'reports' | 'settings' | 'overview' | 'live-status' | 'bookings' | 'cafe-details' | 'analytics' | 'billing' | 'inventory';
